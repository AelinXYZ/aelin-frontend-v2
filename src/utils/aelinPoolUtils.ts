...
export function getVestingDates(
  ...
  return {
    ...
    starts: {
      ms: vestingPeriodStartsMs,
    },
    ends: {
      ms: vestingPeriodStartsMs + vestingPeriodMs,
    },
  }
}
