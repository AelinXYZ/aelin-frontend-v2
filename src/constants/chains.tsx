...
export const chainsConfig: Record<ChainsValues, ChainConfig> = {
  ...
  [Chains.kovan]: {
    ...
    isProd: false,
    name: 'Kovan',
    rpcUrl: `https://kovan.infura.io/v3/${process.env.NEXT_PUBLIC_INFURA_PROJECT_ID}`,
    shortName: 'Kovan',
    tokenListUrl: 'https://gateway.ipfs.io/ipns/tokens.1inch.eth',
  },
  [Chains.optimism]: {
    ...
    chainIdHex: '0xa',
    rpcUrl: `https://optimism-mainnet.infura.io/${process.env.NEXT_PUBLIC_INFURA_PROJECT_ID}`,
