...
import useAelinDepositsHistory from '@/src/hooks/aelin/history/useAelinDepositsHistory'
...
export const Deposits: React.FC = ({ ...restProps }) => {
  ...
  const { data, error, hasMore, nextPage } = useAelinDepositsHistory(variables)
