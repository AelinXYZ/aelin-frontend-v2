...
export const Eth: React.FC<{ className?: string }> = (props) => (
  <Wrapper
    ...
    {...props}
  >
    <path d="M17 0H0V17H17V0Z" fill="url(#ethPatt3rn)" />
    <defs>
      <pattern height="1" id="ethPatt3rn" patternContentUnits="objectBoundingBox" width="1">
        <use transform="scale(0.0078125)" xlinkHref="#image0_1849_2999439030" />
      </pattern>
      <image
        height="128"
        id="image0_1849_2999439030"
        width="128"
