...
const envVars = {
  ...
  NEXT_PUBLIC_ANKR_MAINNET_TOKEN_PROVIDER: process.env.NEXT_PUBLIC_ANKR_MAINNET_TOKEN_PROVIDER,
  NEXT_PUBLIC_ANKR_ARBITRUM_TOKEN_PROVIDER: process.env.NEXT_PUBLIC_ANKR_ARBITRUM_TOKEN_PROVIDER,
  NEXT_PUBLIC_ANKR_OPTIMISM_TOKEN_PROVIDER: process.env.NEXT_PUBLIC_ANKR_OPTIMISM_TOKEN_PROVIDER,
  NEXT_PUBLIC_ANKR_GOERLI_TOKEN_PROVIDER: process.env.NEXT_PUBLIC_ANKR_GOERLI_TOKEN_PROVIDER,
  NEXT_PUBLIC_ANKR_POLYGON_TOKEN_PROVIDER: process.env.NEXT_PUBLIC_ANKR_POLYGON_TOKEN_PROVIDER,
...
const envConfig: Record<EnvKey, ValidatorSpec<string | number | boolean>> = {
  ...
  NEXT_PUBLIC_ANKR_MAINNET_TOKEN_PROVIDER: str(),
  NEXT_PUBLIC_ANKR_ARBITRUM_TOKEN_PROVIDER: str(),
  NEXT_PUBLIC_ANKR_OPTIMISM_TOKEN_PROVIDER: str(),
  NEXT_PUBLIC_ANKR_GOERLI_TOKEN_PROVIDER: str(),
  NEXT_PUBLIC_ANKR_POLYGON_TOKEN_PROVIDER: str(),
  NEXT_PUBLIC_RPC_PROVIDER: str(),
