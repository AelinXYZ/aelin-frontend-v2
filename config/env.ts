...
const envVars = {
  ...
  NEXT_PUBLIC_SEPOLIA_TOKEN_PROVIDER: process.env.NEXT_PUBLIC_SEPOLIA_TOKEN_PROVIDER,
  ...
  NEXT_PUBLIC_GRAPH_ENDPOINT_SEPOLIA: process.env.NEXT_PUBLIC_GRAPH_ENDPOINT_SEPOLIA,
  NEXT_PUBLIC_GRAPH_ENDPOINT_ZK_SYNC: process.env.NEXT_PUBLIC_GRAPH_ENDPOINT_ZK_SYNC,
  NEXT_PUBLIC_GRAPH_ENDPOINT_ZK_SYNC_TESTNET:
    process.env.NEXT_PUBLIC_GRAPH_ENDPOINT_ZK_SYNC_TESTNET,
...
const envConfig: Record<EnvKey, ValidatorSpec<string | number | boolean>> = {
  ...
  NEXT_PUBLIC_SEPOLIA_TOKEN_PROVIDER: str(),
  ...
  NEXT_PUBLIC_GRAPH_ENDPOINT_SEPOLIA: url(),
  NEXT_PUBLIC_GRAPH_ENDPOINT_ZK_SYNC: url(),
  NEXT_PUBLIC_GRAPH_ENDPOINT_ZK_SYNC_TESTNET: url(),
